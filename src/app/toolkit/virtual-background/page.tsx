...
const MemberDetailPage = () => {
  ...
  const [activeTab, setActiveTab] = useState("virtual-background");
                    ...
                    <div className="space-y-1 p-1">
                      <Button
                        ...
                        onClick={() => {
                          ...
                          setEmailSubject(beforeCursor + "{Lead's First Name}" + afterCursor);
                        }}
                      >
                        Lead&apos;s First Name
                      </Button>
                    ...
                    <div className="space-y-1 p-1">
                      <Button
                        ...
                        onClick={() => {
                          ...
                          setEmailBody(beforeCursor + "{Lead's First Name}" + afterCursor);
                        }}
                      >
                        Lead&apos;s First Name
                      </Button>
                    ...
                    {mockSignatureData.showProfilePic && (
                      <div className="relative flex justify-center mb-4">
                        <div className="w-24 h-24 bg-gray-200 rounded-full overflow-hidden flex-shrink-0">
                          <Image
                            src={mockSignatureData.profilePic}
                            alt="Profile"
                            className="w-full h-full object-cover"
                          />
                        </div>
                        ...
                        {mockSignatureData.showCompanyLogo && (
                          <div className="absolute -top-1 -right-1 w-8 h-8 bg-white rounded-full overflow-hidden border-2 border-white shadow-lg">
                            <Image
                              src={mockSignatureData.companyLogo}
                              alt="Company"
                              className="w-full h-full object-cover"
                            />
                          </div>
                    ...
                    {mockSignatureData.showQRCode && (
                      <>
                        <div className="w-20 h-20 bg-gray-100 rounded-md border border-gray-200 flex items-center justify-center mb-2">
                          <Image
                            src={data?.data.userCard?.qrCodeUrl} // Placeholder for QR code
                            alt="QR Code"
                            width={80}
                            height={80}
                            className="object-cover"
      ...
      case "email-signature":
        ...
        const downloadEmailSignature = async () => {
          ...
          try {
            ...
            // Temporarily remove scaling for better capture
            ...
            const canvas = await html2canvas(element as HTMLElement, {
              ...
              allowTaint: true,
              logging: false,
              width: 500, // Fixed width for consistency with preview
              height: element.scrollHeight,
            });

            // Create a higher quality canvas by scaling up
            ...
            if (parentElement && originalTransform) {
